...
extern "C"{
  ...
  #define USART_ERROR_TX_BUF_EMPTY (USART_ERROR_BASE + 2)
  #define USART_ERROR_TX_BUFF_SIZE  32
  #define USART_ERROR_RX_BUFF_SIZE  32
  ...
  extern int32_t USART_Write_String(uint8_t *str, uint8_t size);
